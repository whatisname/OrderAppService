          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <!--<div class="table-responsive">-->
                <table id="datatable-checkbox" class="table table-bordered table-condensed jambo_table bulk_action" cellspacing="0" width="100%">
                  <thead>
                  <tr class="headings">
                    <th>
...
<script src="../../static/vendors/pnotify/dist/pnotify.nonblock.js"></script><script>
